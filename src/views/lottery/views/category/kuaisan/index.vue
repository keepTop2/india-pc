...
const lotteryIcons = {
	"5FK3": new URL("/src/assets/zh-CN/lottery/5FK3.jpeg", import.meta.url).href,
	"3FK3": new URL("/src/assets/zh-CN/lottery/3FK3.jpeg", import.meta.url).href,
	MYK3: new URL("/src/assets/zh-CN/lottery/MYK3.jpeg", import.meta.url).href,
};
const gameCode = route.query.gameCode as "5FK3" | "3FK3" | "MYK3";
