...
export const gameplayList: GameplayList = [
	...
	},
	{
		...
		oddsList: [
			...
			{ title: "选择球", optionCode: "合", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "2-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
	{
		gamePlayName: "第二球",
		gamePlayCodes: ["smp_dxdszh_d2q"],
		desc: `大小：开奖号码≥5为“大”，≤4为“小”。<br> 单双：开奖号码1、3、5、7、9为“单”，0、2、4、6、8为“双”。`,
		id: "3",
		actived: false,
		oddsList: [
			...
			{ title: "选择球", optionCode: "合", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "3-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
	{
		gamePlayName: "第三球",
		gamePlayCodes: ["smp_dxdszh_d3q"],
		desc: `大小：开奖号码≥5为“大”，≤4为“小”。<br> 单双：开奖号码1、3、5、7、9为“单”，0、2、4、6、8为“双”。`,
		id: "4",
		actived: false,
		oddsList: [
			...
			{ title: "选择球", optionCode: "合", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "4-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
	{
		gamePlayName: "第四球",
		gamePlayCodes: ["smp_dxdszh_d4q"],
		desc: `大小：开奖号码≥5为“大”，≤4为“小”。<br> 单双：开奖号码1、3、5、7、9为“单”，0、2、4、6、8为“双”。`,
		id: "5",
		actived: false,
		oddsList: [
			...
			{ title: "选择球", optionCode: "合", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "5-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
	{
		gamePlayName: "第五球",
		gamePlayCodes: ["smp_dxdszh_d5q"],
		desc: `大小：开奖号码≥5为“大”，≤4为“小”。<br> 单双：开奖号码1、3、5、7、9为“单”，0、2、4、6、8为“双”。`,
		id: "6",
		actived: false,
		oddsList: [
			...
			{ title: "选择球", optionCode: "合", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "6-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
];
