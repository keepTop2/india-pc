...
export const gameplayList: GameplayList = [
	{
		...
		oddsList: [
			...
			{ title: "选择球", optionCode: "质", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "1-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
	{
		gamePlayName: "十位",
		gamePlayCodes: ["smp_sw_dxdszh"],
		...
		oddsList: [
			...
			{ title: "选择球", optionCode: "质", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "2-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
	{
		gamePlayName: "个位",
		gamePlayCodes: ["smp_gw_dxdszh"],
		desc: `投注一种属性，投注的属性与该位置的开奖号码属性相同时，即中奖<br>大小：开奖号码≥5为“大”，≤4为“小”<br>单双：开奖号码1、3、5、7、9为“单”，0、2、4、6、8为“双”`,
		id: "3",
		actived: false,
		oddsList: [
			...
			{ title: "选择球", optionCode: "质", desc: "", minBet: 10, maxBet: 1000, itemOdds: "7.995", id: "3-5", actived: false, type: "selectBall", ballNum: 10 },
		],
	},
	{
		gamePlayName: "百十位",
