...
import FootballList from "/@/views/sports/views/football/components/footballCard/footballCard.vue";
import BasketballList from "/@/views/sports/views/basketball/components/rollingCard/rollingCard.vue";
import TennisList from "/@/views/sports/views/tennis/components/rollingCard/rollingCard.vue";
import ESportsList from "/@/views/sports/views/eSports/components/rollingCard/rollingCard.vue";
import VolleyballList from "/@/views/sports/views/volleyball/components/rollingCard/rollingCard.vue";
import IceHockeyList from "/@/views/sports/views/iceHockey/components/rollingCard/rollingCard.vue";
import BilliardsList from "/@/views/sports/views/billiards/components/rollingCard/rollingCard.vue";
import BaseballList from "/@/views/sports/views/baseball/components/rollingCard/rollingCard.vue";
import BadmintonList from "/@/views/sports/views/badminton/components/rollingCard/rollingCard.vue";
import AmericanSoccerList from "/@/views/sports/views/americanSoccer/components/rollingCard/rollingCard.vue";
