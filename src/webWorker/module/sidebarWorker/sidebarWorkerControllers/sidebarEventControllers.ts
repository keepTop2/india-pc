...
class SidebarEventControllers implements WorkerControllerI {
	...
	// 单例实例变量
	// private static instance: SidebarEventControllers;
	// 私有构造函数，确保单例模式
	// private constructor() {}
	// // 获取单例实例的静态方法
	// public static getInstance(): SidebarEventControllers {
	// 	if (!SidebarEventControllers.instance) {
	// 		// 如果实例不存在，则创建
	// 		SidebarEventControllers.instance = new SidebarEventControllers();
	// 	}
	// 	// 返回单例实例
	// 	return SidebarEventControllers.instance;
	// }
 ...
 */
// const sportEventSourceController = SidebarEventControllers.getInstance();
